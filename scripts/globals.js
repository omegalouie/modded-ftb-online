...
// resize the canvas to fill browser window dynamically
    ...
    nShape = 0,
    newGraph = true,
// add in the center of the tank
    tankpointx = c.width / 2,
    tankpointy = c.height / 2,
// self explanatory.
    offset = {};
offset.x = 0;
offset.y = 0;
...
function Barrel(a, type, size, speed, time) {
	...
	this.aspect = document.getElementById("aspect").value;
