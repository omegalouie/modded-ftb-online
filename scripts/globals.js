...
function editButtonClick() {
    if (editmode === false) {
        ...
        accel.y = 0;
        tankalpha = 1.0;
        showhide("visible", "hidden", "hidden", "hidden", "visible", "hidden", "hidden", "hidden");
    } else {
        editmode = false;
        showhide("hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden");
    }
}

function bodyClick() {
    showhide("visible", "visible", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden");
}

function barrelClick() {
    showhide("visible", "hidden", "visible", "hidden", "hidden", "hidden", "hidden", "hidden");
}

function bulletClick() {
    showhide("visible", "hidden", "hidden", "visible", "hidden", "hidden", "hidden", "hidden");
}
...
function infoClick() {
    showhide("visible", "hidden", "hidden", "hidden", "hidden", "visible", "hidden", "hidden");
}

function settingsClick() {
    showhide("visible", "hidden", "hidden", "hidden", "hidden", "hidden", "visible", "hidden");
}

function changeClick() {
	showhide("visible", "hidden", "hidden", "hidden", "hidden", "hidden", "hidden", "visible");
}
function showhide(e, bo, ba, bu, sa, inf, se, cha) {
